	...
	*/	
	public static function transformXmlStringToJson($xmlStringContents) {
		...
		*/
		...
		$array1 = Tools_Xml2json::convertSimpleXmlElementObjectIntoArray($simpleXmlElementObject);
		...
		if (get_class($simpleXmlElementObject) == SIMPLE_XML_ELEMENT_PHP_CLASS) {
   		...
   		if (is_array($simpleXmlElementObject)) {
       		...
       		foreach($simpleXmlElementObject as $key=>$value) {
				...
				$recursionDepth++;	       			
           		$resultArray[$key] = Tools_Xml2json::convertSimpleXmlElementObjectIntoArray($value, $recursionDepth);
